<?php
$MESS['PROSPEKTWEB_PROPMODIFICATOR_MODULE_NAME']        = 'Модификатор свойств ТП (Аспро: Премьер)';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_MODULE_DESCRIPTION'] = 'Добавляет произвольный ввод формата и тиража на карточке товара с интерполяцией цены.';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_INSTALL_TITLE']      = 'Установка модуля «Модификатор свойств ТП»';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_UNINSTALL_TITLE']    = 'Деинсталляция модуля «Модификатор свойств ТП»';

$MESS['PROSPEKTWEB_PROPMODIFICATOR_DEP_ERROR_IBLOCK']   = 'Необходим модуль «Информационные блоки» (iblock)';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_DEP_ERROR_CATALOG']  = 'Необходим модуль «Торговый каталог» (catalog)';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_DEP_ERROR_SALE']     = 'Необходим модуль «Интернет-магазин» (sale)';

// step1.php
$MESS['PROSPEKTWEB_PROPMODIFICATOR_STEP1_SELECT_IBLOCKS']          = 'Выбор инфоблоков';
...
// step2.php
$MESS['PROSPEKTWEB_PROPMODIFICATOR_STEP2_INSTALL_ERROR']   = 'Ошибка при установке:';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_STEP2_INSTALL_SUCCESS'] = 'Модуль <b>prospektweb.propmodificator</b> успешно установлен.';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_STEP2_BACK_TO_MODULES'] = '← Вернуться к модулям';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_STEP2_BTN_NEXT']        = 'Далее →';

// step3.php
$MESS['PROSPEKTWEB_PROPMODIFICATOR_STEP3_SUCCESS']         = 'Установка завершена успешно.';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_STEP3_LINK_SETTINGS']   = '→ Перейти к настройкам модуля';
$MESS['PROSPEKTWEB_PROPMODIFICATOR_STEP3_LINK_MODULES']    = '← Вернуться к списку модулей';
